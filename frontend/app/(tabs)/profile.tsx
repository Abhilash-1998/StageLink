...
const styles = StyleSheet.create({
  ...
  avatarTxt: { color: theme.text, fontSize: 32, fontWeight: "800" },
  name: { color: theme.text, fontSize: 22, fontWeight: "800", letterSpacing: -0.3 },
  tagline: { color: theme.brand, fontSize: 13, marginTop: 4, fontWeight: "600" },
  ...
  actionBtnTxt: { color: theme.text, fontSize: 13, fontWeight: "700" },
  ...
  compTitle: { color: theme.text, fontSize: 14, fontWeight: "700" },
  ...
  suggTxt: { color: theme.textMid, fontSize: 12 },
  ...
  tagBrandTxt: { color: theme.brand, fontSize: 12, fontWeight: "600" },
  price: { color: theme.brand, fontSize: 22, fontWeight: "800", letterSpacing: -0.3 },
  ...
  serviceTitle: { color: theme.text, fontSize: 14, fontWeight: "700" },
  serviceDesc: { color: theme.textDim, fontSize: 12, marginTop: 3, lineHeight: 17 },
  serviceDur: { color: theme.textDim, fontSize: 11, marginTop: 4 },
  servicePrice: { color: theme.brand, fontSize: 15, fontWeight: "800" },
  servicePricing: { color: theme.textDim, fontSize: 10, marginTop: 2 },
  ...
  portTitle: { color: theme.text, fontSize: 10, fontWeight: "700" },
