...
const styles = StyleSheet.create({
  ...
  heroTitle: { ...type.h1, color: "#fff", fontSize: 26 },
  ...
  planPrice: { ...type.h3, color: theme.text, marginTop: 6, fontSize: 22 },
  ...
  bestTagTxt: { fontSize: 10, fontWeight: "800", letterSpacing: 0.5, color: "#fff" },
